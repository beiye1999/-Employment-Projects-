...
<head>
    ...
    <script src="${pageContext.request.contextPath }/WEB-INF/static/script/login.js" type="text/javascript"></script>
</head>
<body>
<header>
  <div class="header-top min-width">
    <div class="container fn-clear"> <strong class="fn-left">咨询热线：18319342799<span class="s-time">服务时间：9:00 - 18:00</span></strong>
      ...
      <ul class="fn-right header-top-ul">
        <li> <a href="${pageContext.request.contextPath }/WEB-INF/jsp/frontend/index.jsp" class="app">返回首页</a> </li>
        <li>
  ...
  <div class="header min-width">
    <div class="container">
      <div class="fn-left logo"> <a class="" href="index.jsp"> <img src="${pageContext.request.contextPath }/WEB-INF/static/images/logo.png"  title=""> </a> </div>
			...
			<ul>
				...
				<li>
				  <span class="dis">验证码：</span><input type="text" onkeyup="verify(this)" id="jpgVerify" style="width:166px;" class="input" name="yzm" data-msg="验证码" maxlength="4" tabindex="1" autocomplete="off">
						<img src="${pageContext.request.contextPath }/WEB-INF/static/images/code.jpg" id="yanzheng" alt="点击更换验证码" title="点击更换验证码" style="cursor:pointer;" class="valign">
