...
<script src="${pageContext.request.contextPath }/WEB-INF/static/script/ablumn.js"></script>
<script src="${pageContext.request.contextPath }/WEB-INF/static/script/plugins.js"></script>
<script src="${pageContext.request.contextPath }/WEB-INF/static/script/detail.js"></script>
</head>
<body>
<header>
      ...
      <ul class="header_contact">
        <li class="c_1"> <a class="ico_head_weixin" id="wx"></a>
          <div class="ceng" id="weixin_xlgz" style="display: none;">
            <div class="cnr"> <img src="${pageContext.request.contextPath }/WEB-INF/static/images/code.png"> </div>
              ...
              <div class="warrant"> <span class="f14 c-888">（注：为保护借款人的个人隐私信息，实物材料对部分信息进行了隐藏处理）</span>
                <div class="album" id="album">
                  <div class="album-show">
                    ...
                    <img src="${pageContext.request.contextPath }/WEB-INF/static/images/news.jpg"> </div>
                  <div class="album-thumb"> <a href="javascript:;" class="btn btn-prev"></a> <a href="javascript:;" class="btn btn-next"></a>
                    <div style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; width: 1070px;" class="container" id="albumThumb">
                      <ul style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 1926px; left: 0px;">
                        <li style="overflow: hidden; float: left; width: 164px; height: 108px;"><a class="small_img" id="images/news.jpg"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/news.jpg"></a></li>
                        <li style="overflow: hidden; float: left; width: 164px; height: 108px;"><a class="small_img" id="images/news.jpg"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/news.jpg"></a></li>
                        <li style="overflow: hidden; float: left; width: 164px; height: 108px;"><a class="small_img" id="images/news.jpg"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/news.jpg"></a></li>
                        <li style="overflow: hidden; float: left; width: 164px; height: 108px;"><a class="small_img" id="images/news.jpg"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/news.jpg"></a></li>
                        <li style="overflow: hidden; float: left; width: 164px; height: 108px;"><a class="small_img" id="images/news.jpg"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/news.jpg"></a></li>
...
<div id="footer" class="ft">
  <div class="ft-inner clearfix">
    <div class="ft-helper clearfix">
      ...
      <dl>
        <dt>相关业务</dt>
        <dd><a href="list.jsp">我要投资</a><a href="我要借款.html">我要借款</a></dd>
      </dl>
      <dl>
        <dt>帮助中心</dt>
    ...
    <div class="ft-wap clearfix">
      <dl>
        <dt>官方二维码</dt>
        <dd><span class="icon-ft-erweima"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/code.png" style="display: inline;"></span></dd>
      </dl>
    </div>
  </div>
  <div class="ft-record">
