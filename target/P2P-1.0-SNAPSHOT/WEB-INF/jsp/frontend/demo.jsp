...
<link rel="stylesheet" href="${pageContext.request.contextPath }/WEB-INF/static/css/bootstrap.min.css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath }/WEB-INF/static/css/layer.css" />

<script type="text/javascript" src="${pageContext.request.contextPath }/WEB-INF/static/script/jquery.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/WEB-INF/static/script/layer.js"></script>
...
<p><a href="${pageContext.request.contextPath }/WEB-INF/jsp/frontend/index.jsp" >返回首页</a></p>
</div>
