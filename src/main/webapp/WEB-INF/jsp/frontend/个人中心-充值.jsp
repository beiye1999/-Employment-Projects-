...
<header>
  ...
  <div class="header min-width">
    <div class="container">
      <div class="fn-left logo"> <a class="" href="/"> <img src="${pageContext.request.contextPath }/WEB-INF/static/images/logo.png"  title=""> </a> </div>
...
<div class="wrapper wbgcolor">
			<div class="w1200 personal">
		    	<div class="credit-ad"><img src="${pageContext.request.contextPath }/WEB-INF/static/images/clist1.jpg" width="1000" height="80"></div>
            ...
            <form id="recharge" name="recharge" method="post" action="#" target="_blank">
              ...
              <div class="pay-bank" id="pay-bank">
                ...
                <ul id="paysSpan" style="height:150px;">
                  <li><img src="${pageContext.request.contextPath }/WEB-INF/static/images/bank_002.gif" property1="icbc" class="on"><em></em><i></i></li>
                  <li><img src="${pageContext.request.contextPath }/WEB-INF/static/images/bank_006.gif" property1="abc"><em></em></li>
                  <li><img src="${pageContext.request.contextPath }/WEB-INF/static/images/bank_001.gif" property1="boc"><em></em></li>
                  <li><img src="${pageContext.request.contextPath }/WEB-INF/static/images/bank_004.gif" property1="ccb"><em></em></li>
                  ...
                  <li><img src="${pageContext.request.contextPath }/WEB-INF/static/images/bank-xyyh.gif" property1="cib"><em></em></li>
                </ul>
...
<script src="${pageContext.request.contextPath }/WEB-INF/static/script/jquery.datetimepicker.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath }/WEB-INF/static/script/datepicker.js" type="text/javascript"></script>
</body>
</html>
