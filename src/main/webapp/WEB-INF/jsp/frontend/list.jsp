...
<link href="${pageContext.request.contextPath }/WEB-INF/static/css/common.css" rel="stylesheet" />
<link href="${pageContext.request.contextPath }/WEB-INF/static/css/index.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath }/WEB-INF/static/css/detail.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="${pageContext.request.contextPath }/WEB-INF/static/script/jquery.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/WEB-INF/static/script/common.js"></script>
</head>
<body>
<header>
  ...
  <div class="invest-list mrt30 clearfix">
    ...
    <div class="bd">
      <div class="invest-table clearfix">
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a class="f18" href="infor.html" title="赵女士长安福特福克斯汽车质押贷款4万元" target="_blank"> 赵女士长安福特福克斯汽车质... </a></li>
            ...
            <li class="col-120-2"> <a class="ui-btn btn-gray" href="infor.jsp">还款中</a> </li>
          </ul>
        </div>
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a class="f18" href="infor.jsp" title="唐先生宝马318汽车质押贷款5万元" target="_blank"> 唐先生宝马318汽车质押贷... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a class="f18" href="infor.jsp" title="秦先生雪佛兰赛欧汽车质押贷款2万元" target="_blank"> 秦先生雪佛兰赛欧汽车质押贷... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a class="f18" href="infor.jsp" title="曾先生北京现代悦动汽车质押贷款3万元" target="_blank"> 曾先生北京现代悦动汽车质押... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a class="f18" href="infor.jsp" title="李先生海马普力马汽车质押贷款3.5万元" target="_blank"> 李先生海马普力马汽车质押贷... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-fang" title="房易贷"></i></a><a class="f18" href="infor.jsp" target="_blank"> 温先生单独所有房产抵押贷款... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-fang" title="房易贷"></i></a><a class="f18" href="infor.jsp" title="孙先生单独所有房产、车位抵押贷款26万元" target="_blank"> 孙先生单独所有房产、车位抵... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a class="f18" href="#" title="马先生宝马X3汽车抵押贷款27万元" target="_blank"> 马先生宝马X3汽车抵押贷款... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor.jsp" target="_blank"><i class="icon icon-fang" title="房易贷"></i></a><a class="f18" href="#" title="吴女士单独所有房产抵押贷款13万元" target="_blank"> 吴女士单独所有房产抵押贷款... </a></li>
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="#" target="_blank"><i class="icon icon-fang" title="房易贷"></i></a><a class="f18" href="infor.jsp" title="李先生夫妻共有房产抵押贷款15万元" target="_blank"> 李先生夫妻共有房产抵押贷款... </a></li>
