...
<div class="flexslider">
    <ul class="slides">
        <li style="background-image: url(${pageContext.request.contextPath }/static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
        <li style="background-image: url(${pageContext.request.contextPath }/static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
        <li style="background-image: url(${pageContext.request.contextPath }/static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
        <li style="background-image: url(${pageContext.request.contextPath }/static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="# " target="_blank"></a></li>
        <li style="background-image: url(${pageContext.request.contextPath }/static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
...
<script src="${pageContext.request.contextPath }/static/script/jquery.flexslider-min.js"></script>
<script type="text/javascript">
    $(function(){
        ...
        <div class="page-right fn-right" style="top: 0px;">
            ...
            <div class="mod mod-report ui-tab clearfix mrt20">
                ...
                <div class="bd">
                    <div class="ui-tab-cont">
                        <div class="ui-tab-item active">
                            <div class="headlines"> <img src="${pageContext.request.contextPath }/static/images/news.jpg"> <a title="平台遭遇P2P滑稽抄袭" target="_blank" href="#">平台遭遇P2P滑稽抄袭</a><br>
            ...
            <div class="mrt20 mod"> <a href="#"><img src="${pageContext.request.contextPath }/static/images/pic_home_js.jpg" width="300" height="80" alt="收益计算器" class="pic"></a></div>
        </div>
    </div>
</div>
            ...
            <div class="ui-tab-cont">
                <div class="ui-tab-item active">
                    <div class="img-scroll">
                        <div class="container">
                            <ul>
                                <li><img src="${pageContext.request.contextPath }/static/images/logo_sbcvc.png" width="152" height="52" alt="软银"></li>
                                <li><img src="${pageContext.request.contextPath }/static/images/logo_abc.png" width="152" height="52" alt="农业银行"></li>
                                <li><img src="${pageContext.request.contextPath }/static/images/logo_wdzj.png" width="152" height="52" alt="网贷之家"></li>
                                <li><img src="${pageContext.request.contextPath }/static/images/logo_baidu.png" width="152" height="52" alt="百度"></li>
                                <li><img src="${pageContext.request.contextPath }/static/images/logo_aqb.png" width="152" height="52" alt="安全宝"></li>
                                <li><img src="${pageContext.request.contextPath }/static/images/logo_gds.png" width="152" height="52" alt="万国数据"></li>
                            </ul>
                        </div>
                    </div>
                </div>
